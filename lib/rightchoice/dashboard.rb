...
module Rightchoice
  class Dashboard < Sinatra::Base
    ...
    get '/' do
      @experiments = Rightchoice::Experiment.all
      erb :index
    end

    post '/:experiment' do
      @experiment = Rightchoice::Experiment.find(params[:experiment])
      @alternative = Rightchoice::Alternative.find(params[:alternative], params[:experiment])
